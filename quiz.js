...
/* ════════════════════════════════════════════════════════════════════
   开放性关系人格测试
   题库 / 计分 / 文案全部来自《开放性关系人格测试_完整开发文档》最终完整版 v4.0
   ════════════════════════════════════════════════════════════════════ */
...
const QUESTIONS = [
  {
    ...
    options: [
      ...
      { text: '有点兴奋', scores: { VG: 2, CK: 1 } },
      { text: '明显兴奋，甚至想参与或安排', scores: { HW: 2, CK: 1, VG: 1 } },
      { text: '超级兴奋，尤其是想到多人一起玩的画面', scores: { GP: 3, HW: 1, CK: 1 } },
    ],
  },
  {
    ...
    options: [
      ...
      { text: '问清楚细节后表示可以接受', scores: { PS: 2, PR: 1 } },
      { text: '立刻问"什么时候？我可以帮你找人 / 我要不要在场？"', scores: { HW: 3, CK: 1 } },
      { text: '立刻问"要不要找几个人一起？群P怎么样？"', scores: { GP: 2, HW: 2, SW: 1 } },
    ],
  },
  {
    text: '你更享受以下哪种情况？',
  ...
  },
  {
    ...
    options: [
      ...
      { text: '爱可以专一，性可以适当开放', scores: { PS: 2, MO: 1 } },
      { text: '性和爱完全可以分开，甚至分开更爽', scores: { PS: 2, CK: 1, HW: 1 } },
      { text: '标签不重要，当下真实的连接和快感才重要', scores: { RA: 3 } },
      { text: '性就是玩，多人一起玩最刺激', scores: { GP: 3, PS: 1 } },
    ],
  },
  {
    text: '你理想中的多边/开放状态是？',
    options: [
      ...
      { text: '理想是固定伴侣 + 经常的多人群P', scores: { GP: 3, KT: 1 } },
    ],
  },
  {
    ...
    options: [
      ...
      { text: '兴奋，觉得对方被别人认可很性感', scores: { VG: 2, CK: 1 } },
      { text: '超级兴奋，甚至想推动这件事继续发展', scores: { HW: 2, CK: 1, VG: 1 } },
      { text: '兴奋到想立刻安排多人一起玩', scores: { GP: 3, HW: 1 } },
    ],
  },
  {
    text: '你愿意自己被"绿"到什么程度？',
    options: [
      ...
      { text: '可以接受对方有约，但不要太频繁、不要太深入', scores: { MO: 2, CK: 1 } },
      { text: '可以接受对方和别人做爱，自己知道细节就很刺激', scores: { VG: 2, CK: 2 } },
      { text: '希望对方被玩得很投入，自己越被"忽视"越兴奋', scores: { CK: 3, HW: 1 } },
      { text: '希望对方被多人一起玩，自己在旁边看或参与', scores: { GP: 2, CK: 2, HW: 1 } },
    ],
  },
  {
    text: '你更倾向于？',
    options: [
      ...
      { text: '如果对方想，我可以勉强接受', scores: { MO: 2, CK: 1 } },
      { text: '我自己有点想看/想被绿，但不会主动提', scores: { VG: 2, CK: 1 } },
      { text: '我会主动提议，甚至安排对方出去玩', scores: { HW: 3, CK: 1 } },
      { text: '我会主动安排群P或多人play', scores: { GP: 3, HW: 1 } },
    ],
  },
  {
    text: '关于"在场"或多人参与，你更喜欢？',
    options: [
      { text: '绝对不能有别人在场或参与', scores: { PL: 3 } },
      { text: '对方出去约可以，但我不要知道太多细节', scores: { PR: 2, PS: 1 } },
      { text: '我可以接受听细节或看照片/视频', scores: { VG: 3 } },
      { text: '我最想亲眼看着，或者一起参与', scores: { HW: 2, CK: 1, VG: 1 } },
      { text: '我最喜欢亲眼看伴侣被多人同时play', scores: { GP: 3, HW: 1, CK: 1 } },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { text: '嫉妒可以直接转化成对多人或被绿的兴奋', scores: { GP: 2, CK: 2, HW: 1 } },
    ],
  },
  {
    ...
    options: [
      ...
      { text: '固定伴侣为主，偶尔可以有新鲜感', scores: { PS: 2, MO: 1 } },
      { text: '固定伴侣 + 定期/不定期的外人', scores: { PS: 1, CK: 1, HW: 1, VG: 1 } },
      { text: '没有固定形式，想跟谁发生关系就跟谁，标签不重要', scores: { RA: 3 } },
      { text: '固定伴侣 + 经常的多人3P/群P', scores: { GP: 3, PS: 1 } },
    ],
  },
  {
    text: '当你看到别人的开放/NTR/群sex内容时，你通常？',
    options: [
      ...
      { text: '会代入自己是群P的中心，感觉超级刺激', scores: { GP: 3, HW: 1, CK: 1 } },
    ],
  },
  {
    text: '你更看重关系里的什么？',
    options: [
      ...
      { text: '自由 + 频繁的多人性体验', scores: { GP: 2, RA: 1 } },
    ],
  },
  {
    ...
    options: [
      ...
      { text: '7-8分', scores: { VG: 1, CK: 1, HW: 1, KT: 1 } },
      { text: '9-10分', scores: { HW: 1, CK: 1, RA: 1, PS: 1 } },
      { text: '10分以上（我就是想玩多人）', scores: { GP: 3, HW: 1, CK: 1 } },
    ],
  },
  {
    ...
    options: [
      ...
      { text: '感情和性都可以，甚至喜欢伴侣和多个异性同时有连接', scores: { GP: 2, RA: 1, KT: 1 } },
    ],
  },
  {
    text: '你更喜欢什么样的权力动态或多人场景？',
    options: [
      ...
      { text: '我喜欢在多人场景中是中心（被多人包围或多人伺候）', scores: { GP: 3, HW: 1, CK: 1 } },
    ],
  },
  {
    text: '关于"事后"或多人play后，你更希望？',
    options: [
      { text: '对方出去玩后最好当没发生过', scores: { PL: 3 } },
      { text: '简单说一下就行，不要太细', scores: { PR: 2, MO: 1 } },
      { text: '详细分享过程，我听着很兴奋', scores: { VG: 2, CK: 1 } },
      { text: '详细分享 + 我们立刻再做一次，用这些细节当燃料', scores: { CK: 2, HW: 2 } },
      { text: '详细分享多人play过程，然后我们再一起重温或继续多人', scores: { GP: 2, HW: 1, CK: 1 } },
    ],
  },
  {
    text: '你觉得自己最接近哪种人？',
    options: [
      ...
      { text: '可以开放但很克制的人', scores: { MO: 2, PR: 1 } },
      { text: '享受观看或被绿的人', scores: { VG: 2, CK: 2 } },
      { text: '主动推动开放/让伴侣出去玩的人', scores: { HW: 3, CK: 1 } },
      { text: '喜欢多人群sex的人', scores: { GP: 3 } },
    ],
  },
  {
    ...
    options: [
      ...
      { text: '会按，但心里有点复杂', scores: { VG: 1, CK: 1, HW: 1 } },
      { text: '毫不犹豫按下去，并且想听全过程', scores: { HW: 2, CK: 2 } },
      { text: '毫不犹豫按下去，还会要求她/他今晚被多人一起玩', scores: { GP: 3, HW: 1, CK: 1 } },
    ],
  },
];

/* ─── 并列时的主结果优先级（v4 §4.1，数字越小越优先）
   CK > HW > GP > VG > PS > SW > KT > PR > RA > MO > PL ─── */
const PRIORITY = {
  CK: 1, HW: 2, GP: 3, VG: 4, PS: 5,
  SW: 6, KT: 7, PR: 8, RA: 9, MO: 10, PL: 11,
};

/* ─── 11 种人格（v4 §2 名单 + §7 两版文案） ─── */
const PERSONAS = {
  PL: {
    name: '纯爱者',
    ...
    bold: [
      '你的身体和心都只愿意交给一个人。',
      '别人谈开放、谈分享、谈多人，对你来说像隔着一层玻璃——听得懂，却进不去。',
      '你不是保守，你是认真。',
  ...
  MO: {
    ...
    bold: [
      ...
      '你会在心里反复确认：这只是例外，还是会变成习惯？',
      '你比纯爱者多一点欲望，又比彻底开放的人多一点谨慎。',
      '你在安全区和刺激区之间反复横跳，却始终给自己留着退路。',
      '你允许欲望偶尔越界，但最终还是想回到那个让你安心的人身边。',
    ],
  },
  PS: {
    name: '纯性开放者',
    ...
    bold: [
      ...
      '你不是滥情，你只是诚实。',
      '你把欲望当成正常需求，而不是道德审判。',
      '你可以和一个人心意相通，同时允许身体去感受别的温度。',
      '在你这里，身体自由，才是真正的松弛。',
      '爱可以很专一，性却可以很开放。',
      '你相信，真正的连接不会因为多了几次身体的交换就消失。',
    ],
  },
  VG: {
    name: '观望者',
    tagline: '喜欢看/听对方和别人发生关系，不一定亲自参与',
    soft: [
      '你不一定要下场，但你很享受看着。',
      '对方因为别人而兴奋的样子，反而会点燃你。',
    ...
    bold: [
      ...
      '有时候你会要求对方把过程讲得更细一点，有时候你只是安静地听着，身体却已经有了反应。',
      '你用距离保护自己，也用距离获得快感。',
  ...
  HW: {
    ...
    bold: [
      ...
      '你很清楚自己在做什么——',
      '你把最珍贵的东西分享出去，却在过程中得到了比独占更强烈的快感。',
    ],
  },
  SW: {
    name: '交换者',
    ...
    bold: [
      ...
      '对你来说，真正的开放，是双方都自愿、都享受、都还能好好回来。',
    ],
  },
  KT: {
    name: '共处者',
    tagline: '希望所有人像家人一样相处、一起生活',
    soft: [
  ...
  PR: {
    ...
    bold: [
      ...
      '你不需要知道对方每一次外出的细节，也不需要对方介入你的每一段体验。',
      '你们可以同时存在于彼此的生命里，却各自保持清晰的边界。',
      '对你来说，真正的亲密，是在不失去自我的前提下靠近。',
    ],
  },
  RA: {
    name: '无界者',
    tagline: '拒绝标签、规则、层级，一切随缘流动',
    soft: [
      '你讨厌被定义，也讨厌定义别人。',
  ...
  GP: {
    ...
    tagline: '特别喜欢多人场景',
    soft: [
      '一对一对你来说已经不够过瘾，多人同时在场的画面才真正让你兴奋。',
      '你享受那种被包围、被共享、或同时服务多人的强度。',
      '边界可以谈，但刺激的上限你想拉得更高。',
      '你比大多数人更直接地承认：有时候，人多就是正义。',
    ],
    bold: [
      '一对一对你来说已经不够过瘾，多人同时在场的画面才真正让你兴奋。',
      '你享受那种被包围、被共享、或同时服务多人的强度。',
      '呼吸交叠，身体交错，注意力被分散又被放大——这种混乱对你而言是高级的刺激。',
      '边界可以谈，但刺激的上限你想拉得更高。',
      '你比大多数人更直接地承认：有时候，人多就是正义。',
      '你追求的不是简单的新鲜感，而是密度更高的欲望现场。',
      '你可以是被多人关注的中心，也可以是主动安排一切的人。',
      '对你来说，真正的高潮，往往发生在人与人之间的界限开始模糊的时候。',
    ],
  },
};
...
/* ─── 匹配度（v4 §5）───
   ...
   （v4 原始公式 70 + primary/max*27 因主分==最高分而恒等于 97，
    故用理论满分比值产生区分度，展示区间遵循 §5.3）
   次结果：§5.1 公式，钳到 [40, 主-8] ─── */
...
const DIMENSIONS = [
  {
    ...
    name: '嫉妒-兴奋转化度',
    map: {
      0: [0, 1, 2, 3, 3], 5: [0, 1, 2, 3, 3], 6: [0, 1, 2, 3, 3],
      9: [0, 1, 2, 3, 3], 10: [0, 1, 3, 1, 3], 19: [0, 1, 2, 3, 3],
    },
    desc: {
  ...
  },
  {
    ...
    name: '主动性',
    map: {
      1: [0, 1, 2, 3, 3], 2: [0, 1, 1, 3, 2],
      7: [0, 1, 1, 3, 3], 16: [0, 1, 1, 3, 2],
    },
    desc: {
  ...
  },
  {
    ...
    name: '性爱分离度',
    map: {
      3: [0, 2, 3, 2, 3], 11: [0, 1, 2, 3, 3], 13: [0, 1, 2, 2, 3],
      14: [0, 1, 2, 3, 3], 15: [0, 2, 2, 3, 3],
    },
    desc: {
  ...
  },
  {
    ...
    name: '关系结构偏好',
    map: {
      4: [1, 0, 3, 1, 2], 8: [0, 0, 1, 3, 3],
      13: [1, 0, 3, 1, 1], 15: [0, 1, 2, 3, 3],
    },
    desc: {
  ...
  },
  {
    ...
    name: '多人偏好度',
    map: {
      2: [0, 0, 0, 1, 3], 4: [0, 0, 1, 1, 3], 8: [0, 0, 0, 1, 3],
      11: [0, 0, 1, 1, 3], 12: [0, 0, 0, 1, 3], 16: [0, 0, 0, 1, 3],
      19: [0, 0, 0, 1, 3],
    },
    desc: {
      high: '多人同场的密度和强度，正是你最想要的现场。',
      mid: '你对多人场景有兴趣，但更像偶尔的调剂。',
      low: '你更喜欢一对一或两个人的世界，人多反而出戏。',
    },
  },
];
...
const LAST_KEY = 'quiz_last_answers_v4';

/* ─── 计分（§4.1 / §4.3） ─── */
function computeScores(answers) {
  const scores = {
    PL: 0, MO: 0, PS: 0, VG: 0, CK: 0, HW: 0,
    SW: 0, KT: 0, PR: 0, RA: 0, GP: 0,
  };
